...
|---|---|---|---|
| Spec 10 API compatibility | versioned generated client | Exact package pin and schema compatibility CI | `0.7.0` exact vendored pin verified; external publication pending |
...
| Spec 11.4–11.14 screens | routed feature modules | Component, integration, accessibility and E2E | Scanner and paper position open/close/re-hedge/exit monitoring implemented; later M2 tabs pending |
